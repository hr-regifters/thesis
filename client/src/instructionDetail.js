exports.instructions = [
  'Choose a Web Service to listen to, if you haven\'t yet connected the service with Ripple you will be redirected to login. Don\'t worry, you\'ll only have to do this once.',
  ...
  'Now let\'s choose what will happen when when Ripple hears that Trigger. Click "Action" to reveal more.',
  'Now select a Web Service that will fire as your Action. Again, if you haven\'t yet connected the service with Ripple you will be redirected to login. You\'ll only have to do this once.',
