...
```
git remote add upstream https://github.com/hr-regifters/thesis.git
```
...
they are satisfied they will merge your changes into upstream development. Alternatively,
